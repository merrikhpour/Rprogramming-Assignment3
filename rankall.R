...
rankall <- function(outcome, num = "best") {
        ...
        if (sum(outcome==c("heart attack", "heart failure", "pneumonia"))==0) { paste("Error in best (",state, outcome, ") : invalid outcome", sep = " ")}
        else if  (sum(outcome==c("heart attack", "heart failure", "pneumonia"))!=0){ 
